...
const activitiesControllers = {
    ...
    getSingleActivity: async (req,res) => {
        ...
        try {
            const selectedActivity = await Activity.findOne({_id: activityId}).populate('itineraryId')
    ...
    updateActivity: async (req, res) => {
        const activityId = req.params.id
        try {
            const modifiedActivity = await Activity.findOneAndUpdate({_id: activityId}, {...req.body}, {new: true})
