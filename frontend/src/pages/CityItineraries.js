        ...
        <main className="main">
          <div className="granContenedor">
            <div
              id="heroAvion"
              className="hero"
              style={{ backgroundImage: `url('${this.state.city.img}')` }}
            ></div>
            ...
            <h2 className="itinerariesSubtitle">
              ¡Here is some of our Itineraries!
            </h2>
            <div className="cityBanners">
              {this.props.itineraries !== null &&
              this.props.itineraries.length !== 0 ? (
                ...
                <div className="cityBanners divErrorBanner notFoundItineraries">
                  <div
                    className="animate__animated animate__fadeIn  errorBanner"
                    style={{
                      backgroundImage: `url('/img/itineraryBackground.jpg')`,
                    }}
                  >
                    <h2 className="cityName">
                      We don't have any itineraries here right now
                    </h2>
              ...
              <div className="d-flex justify-content-center ">
                ...
                <NavLink
                  className="nav-link btnHomeEnCities "
                  exact
                  to="/cities"
                >
                  Back to Cities
