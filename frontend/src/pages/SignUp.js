...
class SignUp extends React.Component {
  ...
  readInput = (e) => {
    ...
    this.setState({
      ...this.state,
      userInfo: { ...this.state.userInfo, [field]: value },
    });
  };
      ...
      if (!respuesta) {
        ...
        switch (respuesta) {
          ...
          case "There was an error in the register.":
            swal(
              "There was an error in the register.",
              "Please verify all the required fields are completed.",
              "error"
            );
            break;
          default:
    ...
    if (e.value.length !== 0) {
      switch (field) {
        ...
        case "repeatpassword":
          ...
          message =
            e.value.length < 6 ||
            !e.value.match(expression) ||
            e.value !== this.state.userInfo.password;
          break;
        case "img":
  ...
  responseGoogle = (response) => {
    if (response.error) {
      ...
      const { givenName, email, googleId, imageUrl, familyName } =
        response.profileObj;
      this.send(null, {
        firstName: givenName,
        lastName: familyName,
        email: email,
        password: "matias" + googleId,
        repeatpassword: "matias" + googleId,
        img: imageUrl,
        country: "null",
      });
    }
      ...
      <div>
        <div className="granContenedor">
          ...
          <main
            ...
            style={{ backgroundImage: "url('./img/backgroundSign.jpg')" }}
          >
              ...
              <form className="needs-validation">
                <div>
                  <svg
                    ...
                    data-prefix="fas"
                    data-icon="user"
                    className="svg-inline--fa fa-user fa-w-14 iconForm"
                    role="img"
                  ...
                  <input
                    className={`form-control ${this.state.validator.firstName}`}
                    onBlur={(e) => this.validate(e.target)}
                    type="text"
                ...
                <div>
                  ...
                  <input
                    className={`form-control ${this.state.validator.lastName}`}
                    onBlur={(e) => this.validate(e.target)}
                    type="text"
                ...
                <div>
                  <svg
                    ...
                    data-prefix="fas"
                    data-icon="envelope"
                    className="svg-inline--fa fa-envelope fa-w-16 iconForm"
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                  >
                  ...
                  <input
                    className={`form-control ${this.state.validator.email}`}
                    onBlur={(e) => this.validate(e.target)}
                    type="text"
                    placeholder="E-Mail"
                    name="email"
                ...
                <div>
                  <svg
                    ...
                    data-prefix="fas"
                    data-icon="key"
                    className="svg-inline--fa fa-key fa-w-16 iconForm"
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                  >
                  ...
                  <input
                    id="password"
                    autoComplete="off"
                    className={`form-control ${this.state.validator.password}`}
                    onBlur={(e) => this.validate(e.target)}
                    type="password"
                    ...
                    onChange={this.readInput}
                  ></input>
                  <p className="aclaration">
                    Password must have min. 6 characters and at least 1 letter
                    and 1 number{" "}
                  </p>
                </div>
                <div>
                  ...
                  <input
                    autoComplete="off"
                    className={`form-control ${this.state.validator.repeatpassword}`}
                    onBlur={(e) => this.validate(e.target)}
                    type="password"
                    placeholder="Repeat Password"
                    name="repeatpassword"
                    value={this.state.userInfo.repeatpassword}
                    onChange={this.readInput}
                  ></input>
                </div>
                <div>
                  <svg
                    ...
                    data-prefix="fas"
                    data-icon="image"
                    className="svg-inline--fa fa-image fa-w-16 iconForm"
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                  >
                  ...
                  <input
                    className={`form-control ${this.state.validator.img}`}
                    onBlur={(e) => this.validate(e.target)}
                    type="text"
                    placeholder="Profile Pic URL link"
                    name="img"
                    value={this.state.userInfo.img}
                    onChange={this.readInput}
                  ></input>
                </div>
                <div className="country">
                  <svg
                    ...
                    className="svg-inline--fa fa-globe-americas fa-w-16 iconForm"
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 496 512"
                  >
                  ...
                  <select
                    className={`form-control ${this.state.validator.country}`}
                    onClickCapture={(e) => this.validate(e.target)}
                    type="select"
                    placeholder="Country"
                    name="country"
