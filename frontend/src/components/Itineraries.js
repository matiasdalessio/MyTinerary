  ...
  const send = (() => {
    if (userLogged) {
      if (comments.comment !=="") {
        ...
        var sendData = {userName: userLogged.firstName, img: userLogged.img, userId:userLogged.id, paramsId, comment}
        addComment(sendData, props.history, itineraryId)
                    ...
                    <div className="containerShowMore">
                      ...
                      <div className="commentaries">
                        ...
                        <div className="divInputComment">  
                            ...
                            <MdSend className="sendComment" onClick={() => send()}/>
                        </div>                    
                      </div>
                    </div>
                </div>                
