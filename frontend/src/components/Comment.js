...
const Activity = ({
  ...
  const [editingComment, setEditComment] = useState({
  ...
  const options = (e) =>
    swal("Want to modify your comment?", "What option do you prefer?", {
      buttons: {
    ...
    <div className="comment">
      <div className="commentContent">
        <div
          ...
          style={{ backgroundImage: `url('${commentInfo.img}')` }}
        />
      ...
      {!editingComment.editing &&
      userLogged &&
      userLogged.id === commentInfo.userId ? (
        <MdMoreVert
          className="optionIcons"
          name={commentInfo.comment}
          onClick={(e) => options(e.target)}
        />
      ) : null}
    </div>
  );
