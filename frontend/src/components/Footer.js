  ...
  return (
    <footer className="footer">
      <div>
        ...
        <p>
          Bonita St 458 - Morro Bay - California |{" "}
          <span>
            <a
              rel="noreferrer"
              className="mapa"
              target="_blank"
              href="https://goo.gl/maps/DHZfj36PPGogvtV56"
            >
              Map
            </a>
          </span>
      ...
      <div className="icons">
        ...
        <a
          rel="noreferrer"
          target="_blank"
          href="https://twitter.com/MytineraryApp"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="40"
      ...
      <div className="navFooter">
        ...
        {props.userLogged ? (
          <>
            <p className="nav-link " onClick={(e) => logOut(e.target)}>
              Log Out
            </p>
          </>
        ) : (
