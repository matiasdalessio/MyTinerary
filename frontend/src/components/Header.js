...
const Header = (props) => {
  ...
  const imagen = props.userLogged
    ? props.userLogged.img
    : "/img/generic-user-icon.jpg";
        ...
        <ul className="nav-item">
          <div className="welcomeAndAvatar">
            <button
              ...
              className="nav-link genericUser"
              data-bs-toggle="dropdown"
            ></button>
            {props.userLogged ? (
              <ul className="dropdown-menu">
                <li className="dropdown-item" onClick={(e) => logOut(e.target)}>
                  Log Out
                </li>
              </ul>
            ) : (
            ...
            <h6 className="welcome">
              {props.userLogged ? `${props.userLogged.firstName}` : null}
            </h6>
          </div>
        </ul>
      </div>
