...
const citiesActions = {
    ...
    fetchCities: (props) => {
        return (dispatch, getState) => {
            axios.get(`https://mytinerary-backend-production-ade7.up.railway.app/api/cities`)
    ...
    fetchSingleCity: (id, props) => {
        return (dispatch, getState) => {
            axios.get(`https://mytinerary-backend-production-ade7.up.railway.app/api/city/${id}`)
